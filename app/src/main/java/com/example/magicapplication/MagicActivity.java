...
public class MagicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.deck1.add(card1);
        this.deck1.add(card2);
        this.deck1.add(card3);
        this.deck1.add(card4);
        this.deck1.add(card5);
        this.deck1.add(card6);
        this.deck1.add(card7);
        this.deck1.add(card8);
        this.deck1.add(card9);
        this.deck1.add(card10);
        this.deck2 = new ArrayList<Card>();
        this.deck2.add(cardA);
        this.deck2.add(cardB);
        this.deck2.add(cardC);
        this.deck2.add(cardD);
        this.deck2.add(cardE);
        this.deck2.add(cardF);
        this.deck2.add(cardG);
        this.deck2.add(cardH);
        this.deck2.add(cardI);
        this.deck2.add(cardJ);
